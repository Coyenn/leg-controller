...
function R6IK.New(Character)
	...
	self.LeftUpperLegLength = 0.8
	self.LeftLowerLegLength = 1

	self.RightUpperLegLength = 0.8
...
function R6IK:LegIK(Side: "Left" | "Right", Position)
	if Side == "Left" then
		...
		local KneeCF = HipCF
			...
			* KneeAngleCFrame
			* CFrame.new(-0.1, -self.LeftLowerLegLength * 0.5, 0)
			* CFrame.new(0, (self.LeftLeg.Size.Y - self.LeftLowerLegLength) * 0.5, 0)
			* CFrame.Angles(0, 0.15, 0)
	...
	elseif Side == "Right" then
		...
		local KneeCF = HipCF
			...
			* KneeAngleCFrame
			* CFrame.new(0.1, -self.RightLowerLegLength * 0.5, 0)
